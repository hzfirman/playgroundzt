...
#url = "https://www.sothebys.com/en/auctions/2019/ceramics-and-jades-from-the-collection-of-sir-quo-wei-lee-hk0902.html?locale=en#&page=all&sort=lotSortNum-asc&range=0|100&viewMode=list"
#url="https://www.sothebys.com/en/auctions/2019/ceramics-and-jades-from-the-collection-of-sir-quo-wei-lee-hk0902.html?locale=en#&page=all&sort=lotSortNum-asc&range=0|100&viewMode=list"
host_name="https://www.sothebys.com"
url="https://www.sothebys.com/zh/auctions/ecatalogue/lot.9.html/2019/ceramics-and-jades-from-the-collection-of-sir-quo-wei-lee-hk0902"
#browser.get(url)
#time.sleep(1)
...
for link in image_list:
        ...
        file_name = lot_name_list[0] + str(file_count)
